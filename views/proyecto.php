      ...
      <div class="modal-content">
        <div class="modal-header text-light" style='background-color: #005478;'>
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item closeP" id="modal-fase"><a type="button" >Proyecto</a></li>
              <li class="breadcrumb-item text-light active" aria-current="page">Fases</li>
            </ol>
          </nav>
          </h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    ...
    <div class="modal-dialog modal-fullscreen">
      <div class="modal-content">
        <div class="modal-header text-light" style='background-color: #005478;'>
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item "><a type="button">Proyecto</a></li>
              <li class="breadcrumb-item closeT" id="fase-modal"><a type="button">Fase</a></li>
              <li class="breadcrumb-item active text-light" aria-current="page">Tarea</li>
            </ol>
          </nav>
          </h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
