                ...
                <div class="row mb-2 mt-2">
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="buscar-colaborador" placeholder="Nombre" name="colaborador">
                            <label for="colaborador" class="form-label">Nombre del Colaborador</label>
                        </div>
                    </div>

                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <select name="nivelacceso" id="buscar-nivelacceso" class="form-control form-control-sm">
                              <label for="nivelacceso">Seleccione el nivel de acceso:</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="buscar-correo" placeholder="Correo" name="correo">
                            <label for="correo" class="form-label">Correo</label>
                        </div>
                    </div>
                </div>
                <button type="button" id="buscar-colaboradores"  class="btn btn-outline-primary">Buscar</button>
