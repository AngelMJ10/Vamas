        ...
        document.addEventListener("DOMContentLoaded", () =>{
            ...
            function obtenerDatosPF() {
                ...
                .then(datos => {
                    ...
                    const labels = datos.data;
                    const data = Array(labels.length).fill(0); // Inicializar los valores de las barras en 0 para cada proyecto
                    ...
                    // Actualizar las opciones del gráfico con el valor máximo actualizado
                    graficoPF.options = getConfigPF('Proyectos finalizados');
            ...
            function renderGraficoPF() {
                const lienzo2 = document.querySelector("#grafico-proyectos-Finalizados");
                const etiquetas = [];
                const coloresFondo = ['rgba(255, 99, 132, 0.2)', 'rgba(54, 162, 235, 0.2)', 'rgba(255, 206, 86, 0.2)', 'rgba(75, 192, 192, 0.2)'];
                const borde = 1;
                const coloresBorde = ['rgba(255, 99, 132, 1)', 'rgba(54, 162, 235, 1)', 'rgba(255, 206, 86, 1)', 'rgba(75, 192, 192, 1)'];

                graficoPF = new Chart(lienzo2, {
                    type: 'bar',
                    data: {
                    labels: etiquetas,
                    datasets: [
                    ...
                    options: getConfigPF('Proyectos finalizados')
                });
